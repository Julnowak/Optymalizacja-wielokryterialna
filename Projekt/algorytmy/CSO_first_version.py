...
def algorithm(start, end, map_size, terrain, visibility_range, num_of_iterations: int = 100, cockroaches_num: int = 20,
              probability_of_dispersion: float = 10, max_step: int = 1, ):
